<template>
  <div class="container">
    <form>
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          ...
          <div class="form-group">
            ...
            <!-- The v-model.lazy displays our input only after we tap away from the field -->
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
          ...
          <select id="priority" class="form-control" v-model="selectedPriority">
            ...
            <!-- :selected="priority == 'Medium'" : Could set a default selected value -->
          </select>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <!-- .prevent prevents us from sending form directly to server. We want to do something else -->
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <!-- white-space: pre enables us to add linebreaks in the textarea -->
